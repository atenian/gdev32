...
void main()
{
    ...
    worldSpaceNormal = normalize(nmatrix1 * vec4(normalVector, 1.0f)).xyz;

    vec3 worldSpaceTangent = normalize(nmatrix1 * vec4(vertexTangent, 1.0f)).xyz;
