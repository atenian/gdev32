...
void main()
{
    ...
    worldSpacePosition = (matrix2 * vec4(vertexPosition, 1.0f)).xyz;
    worldSpaceNormal = normalize(nmatrix2 * vec4(normalVector, 1.0f)).xyz;

    vec3 worldSpaceTangent = normalize(nmatrix2 * vec4(vertexTangent, 1.0f)).xyz;
